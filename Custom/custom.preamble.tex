...
\usepackage[hyperpageref]{backref} %Page 15 backref manual

%---------------------------------
% LATEXDIFF AND EDITING COMMENTS
\newcommand{\comment}[2]{}
...
\newcommand{\vc}{{\sc Vertex Cover}\;}
\newcommand{\vcc}{{\sc Vertex Cover}}
\newcommand{\fpt}{{\sc FPT}\;}
\newcommand{\fptc}{{\sc FPT}}
\newcommand{\N}{{\mathbb{N}}\;}
\newcommand{\Poly}{{$\mathbb{P}$}\;}
\newcommand{\NP}{{$\mathbb{NP}$}\;}
\newcommand{\NPc}{{$\mathbb{NP}$}}
...
\renewcommand{\section}{\@startsection%
  ...
  {0.1mm}% afterskip
  {\selectfont\Large\bfseries}% style   %xetex %{\sectionfont\Large\bfseries}% style
}
\renewcommand{\subsection}{\@startsection%
  ...
  {0.5\baselineskip}% beforeskip
  {0.1mm}% afterskip
  {\selectfont\large\bfseries}% style
  %xetex
